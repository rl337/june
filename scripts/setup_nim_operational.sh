...
echo "  poetry run -m essence verify-nim --nim-host nim-qwen3 --http-port 8003 --grpc-port 8001"
echo ""
echo "Check GPU utilization:"
echo "  nvidia-smi"
echo ""
echo "Test gRPC connectivity:"
echo "  poetry run -m essence verify-nim --nim-host nim-qwen3 --http-port 8003 --grpc-port 8001 --check-grpc"
echo ""
echo "Test protocol compatibility:"
echo "  poetry run -m essence verify-nim --nim-host nim-qwen3 --http-port 8003 --grpc-port 8001 --check-protocol"
echo ""
echo "Test inference (if coding agent is available):"
echo "  poetry run -m essence coding-agent --task 'Hello, world!' --llm-url grpc://nim-qwen3:8001"
echo ""
