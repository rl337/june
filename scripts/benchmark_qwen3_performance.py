#!/usr/bin/env python3
"""
Performance benchmarking suite for Qwen3-30B-A3B model.
...
Usage:
    python scripts/benchmark_qwen3_performance.py [--output-dir OUTPUT_DIR] [--iterations ITERATIONS]
"""
...
# Add parent directory to path to import inference_core
...
def main():
    parser = argparse.ArgumentParser(description="Benchmark Qwen3-30B-A3B performance")
    parser.add_argument(
        "--output-dir",
        type=str,
    ...
    latency_results = run_latency_benchmarks(strategy, gpu_monitor, iterations=args.iterations)
