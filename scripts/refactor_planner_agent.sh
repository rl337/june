#!/bin/bash
# Refactor Planner Agent for June project - Analyzes codebase and creates refactoring tasks
# Usage: refactor_planner_agent.sh
...
export PROMPTS_DIR="${PROMPTS_DIR:-${AGENTICNESS_DIR}/prompts/refactor-planner}"
