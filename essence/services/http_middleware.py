...
def create_tracing_and_metrics_middleware(
    tracer: Optional[object] = None, trace_module: Optional[object] = None
) -> Callable:
    """
            ...
            if tracer is not None:
                ...
                with tracer.start_as_current_span(span_name) as span:
                    ...
                    if status_code >= 400 and trace_module is not None:
                        span.set_status(
                            trace_module.Status(
                                trace_module.StatusCode.ERROR, f"HTTP {status_code}"
                            )
                        )
                ...
                try:
                    ...
                    if current_span:
                        ...
                        current_span.set_status(
                            trace_module.Status(trace_module.StatusCode.ERROR, str(e))
                        )
                except Exception:
