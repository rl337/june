...
def create_error_message(
    ...
    if user_friendly_message is None:
        user_friendly_message = f"❌ I encountered an error processing your request. Please try again."
...
def render_error_for_platform(
    ...
    """
    error_message = create_error_message(exception, user_friendly_message, include_traceback)
