...
class EncryptionManager:
    ...
    def encrypt_file(self, input_file: Union[str, BinaryIO], output_file: Optional[Union[str, BinaryIO]] = None) -> Optional[bytes]:
        """
        Encrypt a file.
    ...
    def decrypt_file(self, input_file: Union[str, BinaryIO], output_file: Optional[Union[str, BinaryIO]] = None) -> Optional[bytes]:
        """
        Decrypt a file.
...
def get_encryption_manager(master_key: Optional[Union[str, bytes]] = None) -> EncryptionManager:
    """
