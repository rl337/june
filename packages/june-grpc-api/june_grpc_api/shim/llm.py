...
class LLMClient:
    ...
    async def generate_stream(self, prompt: str, params: Optional[GenerationParams] = None, timeout: Optional[float] = 30.0) -> AsyncGenerator[str, None]:
    ...
    async def chat(self, messages: List[Dict[str, str]], params: Optional[GenerationParams] = None, timeout: Optional[float] = 30.0) -> str:
    ...
    async def chat_stream(self, messages: List[Dict[str, str]], params: Optional[GenerationParams] = None, timeout: Optional[float] = 30.0) -> AsyncGenerator[str, None]:
