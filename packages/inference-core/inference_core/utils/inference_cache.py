...
class InferenceCache:
    ...
    def put(self, input_data: Any, result: Any, model_name: Optional[str] = None) -> None:
...
def get_llm_cache(max_size: int = 1000, ttl_seconds: Optional[float] = 3600) -> InferenceCache:
...
def get_stt_cache(max_size: int = 500, ttl_seconds: Optional[float] = 7200) -> InferenceCache:
...
def get_tts_cache(max_size: int = 500, ttl_seconds: Optional[float] = 7200) -> InferenceCache:
