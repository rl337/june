...
mock_tracer.start_as_current_span = MagicMock(return_value=Mock(__enter__=lambda self: mock_span, __exit__=lambda *args: None))
...
class TestTracingSpanPatterns:
    ...
    def test_agent_stream_message_span_pattern(self):
        ...
        assert mock_tracer.start_as_current_span.call_args[0][0] == "agent.stream_message"
    ...
    def test_agent_process_message_span_pattern(self):
        ...
        # Verify span was created
        assert mock_tracer.start_as_current_span.called
        assert mock_tracer.start_as_current_span.call_args[0][0] == "agent.process_message"
    ...
    def test_multiple_spans_can_be_created(self):
        ...
        assert mock_tracer.start_as_current_span.call_args_list[0][0][0] == "agent.stream_message"
        assert mock_tracer.start_as_current_span.call_args_list[1][0][0] == "http.request"
    ...
    def test_span_attributes_for_different_operations(self):
        ...
        agent_span_calls = [call[0] for call in mock_span.set_attribute.call_args_list[:3]]
