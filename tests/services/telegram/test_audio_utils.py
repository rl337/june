...
class TestCompressionOptimization:
    ...
    def test_compress_audio_reduces_bitrate_if_too_large(self, sample_audio_segment):
        ...
        expected_bitrate = max(TELEGRAM_MIN_BITRATE, min(calculated_required, TELEGRAM_RECOMMENDED_BITRATE))
        assert compression_info["bitrate_used"] == expected_bitrate
...
class TestNoiseReduction:
    ...
    def test_reduce_noise_handles_missing_librosa(self, sample_wav_16khz_mono, monkeypatch):
