...
class TestTracingSpanPatterns:
    ...
    def test_stt_span_pattern(self):
        ...
        assert mock_tracer.start_as_current_span.call_args[0][0] == "stt.recognize_stream"
    ...
    def test_voice_enhance_audio_span_pattern(self):
        ...
        # Verify span was created
        assert mock_tracer.start_as_current_span.called
        assert mock_tracer.start_as_current_span.call_args[0][0] == "voice.enhance_audio"
    ...
    def test_text_message_span_pattern(self):
        ...
        # Verify span was created
        assert mock_tracer.start_as_current_span.called
        assert mock_tracer.start_as_current_span.call_args[0][0] == "telegram.text_message.handle"
