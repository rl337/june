...
import pytest
from tests.agentic.simulation.mock_execution import MockExecutionEnvironment, ExecutionSimulator
...
class TestSecurityBoundaries:
    ...
    def test_blocks_directory_traversal(self, mock_env):
        ...
        assert str(mock_env.base_path).startswith("/tmp") or str(mock_env.base_path).startswith("/var")
