...
class TestVerificationLogic:
    ...
    def test_verification_runs_tests(self):
        ...
        task = {
            "title": "Add feature",
            "verification_instruction": "Run pytest tests"
        }
    ...
    def test_verification_checks_coverage(self):
        ...
        task = {
            "title": "Add tests",
            "verification_instruction": "Ensure 80% coverage"
        }
    ...
    def test_verification_reports_detailed_results(self):
        ...
        task = {
            "title": "Test task",
            "verification_instruction": "Verify everything"
        }
    ...
    def _run_verification(self, task: Dict[str, Any], simulate_failure: bool = False) -> Dict[str, Any]:
        ...
        if simulate_failure:
            return {
                ...
                "failures": [
                    {"test": "test_feature", "error": "AssertionError"}
                ],
