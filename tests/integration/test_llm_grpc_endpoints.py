...
from june_grpc_api.generated.llm_pb2 import (
    ...
    FinishReason, UsageStats, HealthRequest, HealthResponse
)
...
class TestGenerateEndpoint:
    ...
    async def test_generate_basic(self, grpc_stub, service_available):
        ...
        logger.info(f"Tokens: {response.tokens_generated}, Finish reason: {response.finish_reason}")
    ...
    async def test_generate_max_tokens_parameters(self, grpc_stub, service_available):
        ...
        for max_tokens in max_tokens_values:
            ...
            logger.info(f"Max tokens {max_tokens}: Generated {response.tokens_generated} tokens")
    ...
    @pytest.mark.asyncio
    async def test_generate_error_handling_invalid_request(self, grpc_stub, service_available):
        ...
        try:
            ...
            logger.info(f"Large max_tokens handled: generated {response.tokens_generated} tokens")
...
class TestChatEndpoint:
    ...
    async def test_chat_conversation_history(self, grpc_stub, service_available):
        ...
        logger.info(f"Conversation history response: '{response.message.content[:100]}...'")
    ...
    async def test_chat_various_parameters(self, grpc_stub, service_available):
        ...
        param_sets = [
            ...
            {"temperature": 1.0, "max_tokens": 50, "top_p": 0.95, "repetition_penalty": 1.1},
        ]
    ...
    async def test_chat_long_conversation(self, grpc_stub, service_available):
        ...
        assert "8" in response.message.content or "eight" in response.message.content.lower()
        
        logger.info(f"Long conversation response: '{response.message.content[:100]}...'")
    ...
    async def test_chat_response_schema(self, grpc_stub, service_available):
        ...
        messages = [
            ChatMessage(role="user", content="Test schema.")
        ]
    ...
    @pytest.mark.asyncio
    async def test_chat_error_handling_empty_messages(self, grpc_stub, service_available):
...
class TestResponseQuality:
    ...
    async def test_response_quality_basic(self, grpc_stub, service_available):
        ...
        assert "paris" in response_lower or len(response.text) > 10  # Either correct or substantial
