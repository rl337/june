...
class TestCheckTokenizerFiles:
    ...
    def test_tokenizer_files_found(self):
        ...
        with patch("essence.commands.compile_model.Path") as mock_path_class:
            ...
            mock_tokenizer_files = [
                ...
                MagicMock(
                    relative_to=MagicMock(return_value=Path("tokenizer_config.json"))
                ),
            ...
            def path_constructor(*args):
                ...
                if (
                    "models--Qwen--Qwen3-30B-A3B-Thinking-2507" in path_str
                    or "Qwen--Qwen3-30B-A3B-Thinking-2507" in path_str
                ):
                    return mock_model_dir
            ...
            success, msg, files = check_tokenizer_files(
    ...
    def test_tokenizer_files_not_found(self):
        ...
        with patch("pathlib.Path.exists", return_value=False):
            success, msg, files = check_tokenizer_files(
                "Qwen/Qwen3-30B-A3B-Thinking-2507", "/nonexistent"
            )
...
class TestCompileModelCommand:
    ...
    @patch(
        "sys.argv", ["compile-model", "--model", "qwen3-30b", "--check-prerequisites"]
    )
