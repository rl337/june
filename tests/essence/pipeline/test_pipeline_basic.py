...
class TestPipelineBasic:
    ...
    async def test_complete_pipeline_flow(self, pipeline_framework):
        ...
        # Generate test audio
        audio_data = pipeline_framework.generate_test_audio(
            "Hello world", duration_seconds=1.0
        )
    ...
    async def test_pipeline_with_custom_responses(self, pipeline_framework):
        ...
        stt_response = MockSTTResponse(
            transcript="What is the weather?", confidence=0.95
        )
        ...
        # Generate test audio
        audio_data = framework.generate_test_audio(
            "What is the weather?", duration_seconds=2.0
        )
    ...
    async def test_pipeline_performance(self, pipeline_framework):
        ...
        # Generate test audio
        audio_data = pipeline_framework.generate_test_audio(
            "Test performance", duration_seconds=1.0
        )
    ...
    async def test_pipeline_concurrent_requests(self, pipeline_framework):
        ...
        tasks = [
            pipeline_framework.run_pipeline(audio_data) for audio_data in audio_samples
        ]
