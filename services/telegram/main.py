...
TELEGRAM_MESSAGES_TOTAL = Counter('telegram_messages_total', 'Total Telegram messages processed', ['type'], registry=REGISTRY)
TELEGRAM_COMMANDS_TOTAL = Counter('telegram_commands_total', 'Total Telegram commands processed', ['command'], registry=REGISTRY)
TELEGRAM_VOICE_MESSAGES_TOTAL = Counter('telegram_voice_messages_total', 'Total voice messages processed', ['status'], registry=REGISTRY)
TELEGRAM_VOICE_PROCESSING_TIME = Histogram('telegram_voice_processing_seconds', 'Voice message processing time', registry=REGISTRY)
TELEGRAM_ERRORS_TOTAL = Counter('telegram_errors_total', 'Total errors', ['error_type'], registry=REGISTRY)
TELEGRAM_ACTIVE_USERS = Gauge('telegram_active_users', 'Number of active users', registry=REGISTRY)
TELEGRAM_HEALTH_REQUESTS = Counter('telegram_health_requests_total', 'Total health check requests', registry=REGISTRY)
